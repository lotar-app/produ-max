Release preparata per produzione-stabile (2.3)
...
2) Preparare backup rapido dell'attuale cartella:
   ...
   ln -s "/var/www/releases/produzione-stabile-20250212-2.3" /var/www/produzione-stabile
...
Nota: questa release introduce l'autenticazione con username/password e richiede la tabella `auth_users`.
